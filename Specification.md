...
* ###### QINTokensale.sol (Contract): Crowdsale contract for the QIN Token
...
* ###### BuyerStore.sol (Base Contract): Buyer/Registration Functionality
...
1. ###### A user sends Ethereum to the QINTokensale.sol contract address.
...
#### //TODO: Token standards are not final
...
#### //TODO: Detail split into SafeMath8 + SafeMath256
